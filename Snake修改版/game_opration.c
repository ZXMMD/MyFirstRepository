...
{
	// 调整计时器到时时间
	dwTimerElapse = (DWORD)(dwTimerElapse * (dbLevelSpeedupRatio+0.3));
	KillTimer(hwnd, TIMER_ID);
	SetTimer(hwnd, TIMER_ID, dwTimerElapse, NULL);
	return TRUE;
}
